...
/**
 * Redis configuration. JSON serialization only - Java native serialization is disabled
 * to avoid CVE-2016-XXXX style gadget attacks and cross-version incompatibility.
 */
@Configuration
