...
public abstract class AbstractSearchProvider implements SearchProvider {
    ...
    public final List<RawSearchResult> search(SearchRequest request) {
        ...
        if (circuitBreaker.isOpen(name())) {
            ...
            meters.counter("mysearch.provider.error", "name", name(), "type", "circuit_open").increment();
            return Collections.emptyList();
        }
        ...
        try {
            ...
            sample.stop(Timer.builder("mysearch.provider.latency")
                    .tag("name", name())
                    .register(meters));
            ...
            meters.counter("mysearch.provider.error", "name", name(), "type", type).increment();
