...
class RRFRankerTest {
    ...
    private final PrismsearchProperties props = new PrismsearchProperties();
    ...
    private static SearchProvider fakeProvider(String name, double weight) {
        return new SearchProvider() {
            ...
            @Override public List<RawSearchResult> search(com.prismsearch.model.SearchRequest request) {
                return List.of();
            }
        };
    }
